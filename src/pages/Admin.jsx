...
import { getBoardDetailPage, getDetailPage, getDetailPageForAdmin, getPartyBoard, getPartyPage } from "../utils/api/api";
...
function Board(props){
  return (<>
    <BoardBox>
      ...
      {props.groupMemberRoleEnum === 'ADMIN' ? null : (<Button>탈퇴시키기</Button>)}
    </BoardBox>
  </>)
}
