...
export const PartyRadioBox = styled.div`
  display: flex;
  gap: 1rem;
  align-items: center;
...
export const PartyPageContainer = styled.div`
  display: flex;
  position: relative;
  flex-direction: row;
  align-items: flex-start;
...
export const PartyLeftContainer = styled.div`
  flex-direction: column;
...
export const PartyRightContainer = styled.div`
  margin: 3rem 0;
  display: grid;
